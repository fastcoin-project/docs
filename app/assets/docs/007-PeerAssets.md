...
Creates a new token at a given Fastcoin address. Asset is described by:
* token name,
...
Creates new tokens of `deck` at given Fastcoin address.
...
deployed: https://papi.fastcoin-project.com/api/v1/decks
...
A light, cross-platform Fastcoin wallet with baked-in support for the PeerAssets.
...
The PeerAssets project has adopted [RFC](https://en.wikipedia.org/wiki/Request_for_Comments) schema of sharing new ideas and establishing standards like the Fastcoin project.
...
> Extension of PeerAssets protocol specifies using singlet PeerAsset deck to alias the Fastcoin address with any UTF-8 string with added secondary functionality of using descriptive information contained in the PeerAssets token to allow proof-of-identity verification of the privkey owner.
...
[PeerAssets deck issue modes](https://medium.com/fastcoin/peerassets-deck-issue-modes-c419f38f7800)

[The benefits of PeerAssets](https://medium.com/fastcoin/the-benefits-of-peerassets-77bad7693925)

[[Tutorial] PeerAssets Peer to Peer (p2p) Transactions](https://talk.fastcoin-project.com/t/tutorial-peerassets-peer-to-peer-p2p-transactions/8640)

[[Tutorial] Basic Deck Creation with PeerAssets](https://talk.fastcoin-project.com/t/tutorial-basic-deck-creation-with-peerassets/8639)
